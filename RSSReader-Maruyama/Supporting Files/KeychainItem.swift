...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.maruyama.RSSReader-Maruyama", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.maruyama.RSSReader-Maruyama", account: "userIdentifier").deleteItem()
        } catch {
